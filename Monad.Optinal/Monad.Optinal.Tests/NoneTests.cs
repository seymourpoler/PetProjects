...
namespace Monad.Optinal.Tests
{
    ...
    public class NoneTests
    {
		...
		[Test]
		public void ThrowsArgumentNullExceptionWhenFunctionWithOtherTypeReturnsNullIsNull()
		{
			var monad = new None<string> ();
		...
		[Test]
		public void ThrowsArgumenNullExceptionWhenNoneWithFunctionForSomeAndActionForNoneIsNull()
		{
			const string name = "Tom";
			var monad = new None<string> ();
		...
		public void ThrowsArgumentNullExceptionWhenSomeWithOtherTypeAndNoneWithActionIsNull()
		{
			...
			Action action = () => monad.Bind (() => {return new User{Name = name};}, none: null);	

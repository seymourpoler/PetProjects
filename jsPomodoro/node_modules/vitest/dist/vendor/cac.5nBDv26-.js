...
async function start(mode, cliFilters, options) {
  ...
  try {
    const { startVitest } = await import('./cli-api.BT4NJtxX.js').then(function (n) { return n.h; });
...
async function collect(mode, cliFilters, options) {
  ...
  try {
    const { prepareVitest, processCollected } = await import('./cli-api.BT4NJtxX.js').then(function (n) { return n.h; });

...
public class _Should {
    ...
    @Test
    public void return_empty_list_when_zipping_the_second_list_is_empty(){
        final List<String> fruits = Arrays.asList("berry", "banana");

        final List<String> result = _.zip(fruits, Arrays.asList());
    ...
    @Test
    public void return_empty_list_when_zipping_and_lists_are_empty(){
        final List<String> result = _.zip(Arrays.asList(), Arrays.asList());
    ...
    @Test
    public void return_zipped_when_the_second_list_is_longer_than_the_first(){
        final List<String> animals = Arrays.asList("monkey", "rabbit");
        final List<String> fruits = Arrays.asList("berry", "banana", "apple");

        final List<String> result = _.zip(animals, fruits);

        Assert.assertTrue(result.get(0).equals("monkey"));
        Assert.assertTrue(result.get(4).equals("apple"));
    }
    ...
    @Test
    public void return_the_list_with_added_elements()
    {
        final List<Integer> result = _.add(Arrays.asList(1,2,3,4), 5,6,7);

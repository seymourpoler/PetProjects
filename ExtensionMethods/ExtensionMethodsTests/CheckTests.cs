...
namespace ExtensionMethodsTests
{
    public class CheckTests
    {
        ...
        [Fact]
        public void DoesNotThrowAnExceptionWhenArgumentIsNotEmptyArray()
        {
            var action = () => Check.IsEmpty<CustomException, int>(new[] { 1,2,3 });
        ...
        [Fact]
        public void DoesNotThrowAnExceptionWhenArgumentIsNotNullAndNeitherEmptyArray()
        {
            var action = () => Check.IsNullOrEmpty<CustomException, int>(new[] { 1, 2, 3 });
        ...
        [Fact]
        public void DoesNotThrowAnExceptionWithMessageWhenArgumentIsNotNullAndNeitherEmptyArray()
        {
            var action = () => Check.IsNullOrEmpty<CustomException, int>(new[] { 1, 2, 3 }, aMessage);
